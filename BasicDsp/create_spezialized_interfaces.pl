...
create_specific_interface(
	"IRealTimeDomainVector32", 
	["IGenericVectorOperations32", "IRealVectorOperations32", "ITimeDomainVectorOperations32"], 
	\%generic);
create_specific_interface(
	"IComplexTimeDomainVector32", 
	["IGenericVectorOperations32", "IComplexVectorOperations32", "ITimeDomainVectorOperations32", "IComplexTimeVectorOperations32"], 
	\%generic);
create_specific_interface(
	"IRealFrequencyDomainVector32", 
	["IGenericVectorOperations32", "IRealVectorOperations32", "IFrequencyDomainVectorOperations32"], 
	\%generic);
create_specific_interface(
	"IComplexFrequencyDomainVector32", 
	["IGenericVectorOperations32", "IComplexVectorOperations32", "IFrequencyDomainVectorOperations32", "IComplexFrequencyVectorOperations32"], 
	\%generic);
